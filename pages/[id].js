      ...
      <div className="">
         ...
         <main className="bg-black min-h-screen flex max-w-[1500px] mx-auto">
            ...
            <div className="flex-grow border-x border-1 border-gray-700 max-w-2xl sm:ml-[90px] xl:ml-[315px]">
                <div className="flex items-center px-1.5 py-2 border-b border-gray-700 text-gray-300 font-semibold text-xl gap-x-4 sticky
                 top-0 z-50 bg-black">
                    <div className="hoverAnimation w-9 h-9 flex items-center justify-center px-0 mr-3" onClick={() => router.push('/')}>
